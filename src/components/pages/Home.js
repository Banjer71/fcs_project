		...
		<React.Fragment>
			...
			<Container>
				<MainArticle>
					...
					<hr />
					<p>
						<strong>FCS</strong> Offers a specialized service in: Fabric research, dyeing and textile
						printing for Film, Television, Theatre and Fashion Industry.
					</p>
				</MainArticle>
				<MainArticle>
					<CardSection>
						...
						<Card>
							...
							<p>
								Fabric research or materials necessary to the realization of the sketches as required by
								the designers or specialized atelier. From natural fibers to the latest generation of
								technical fabrics.
							</p>
						</Card>
						<Card>
							...
							<p>
								Custom printing and dyeing of fabric chosen or already available. From screen printing
								to digital, from 2D to 3D, finishing, coatings and laser cutting.
							</p>
						</Card>
					</CardSection>
				</MainArticle>
			...
			<PreFooter>
				<Container>
					<div className="prefooter-text">
						...
						<hr />
						<p>
							The FCS, in collaboration with industry experts, will follow and advise the customer in all
							phases of work, customizing the product according to the stylistic demands of the designer.
							Streamlining and speeding the frantic movie times and optimizing all the stages of
							intermediation between supplier and customer but, above all, our speciality is finding the
							unfindable.
						</p>
